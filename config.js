...
module.exports = {
    ...
    footer: process.env.Footer || "© Powered By Hussain Bot",
     ...
     */
    ownername: process.env.Owner_Name || "Hussain Ahmed",
    ownernumber: process.env.Owner_Number || "01965142856",
    instagramId: process.env.Insta || "not use",

    /**
     * other details and parameters
     */
    author: process.env.Author || "@Hussain2370",
    ...
    sessionId: process.env.SESSION_ID || "dTZ2emc_Queen-Anya_xbWw=",
